...
int32 OS_mkfs (const void *address, const char *devname, const char *volname, uint32 blocksize,
               uint32 numblocks)
{
    int i;
...
---------------------------------------------------------------------------------------*/
int32 OS_initfs (const void *address, const char *devname, const char *volname,
